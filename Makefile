...
PACKAGE=gitlab.ozon.dev/kunata928/telegramBot/cmd/bot
...
generate: install-mockgen
	${MOCKGEN} -source=internal/model/messages/messages.go -destination=internal/mocks/messages/messages_mocks.go
